                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input id="title" name="title" value="{{ $post->title }}" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="@lang('admin.title')">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input id="description" name="description" value="{{ $post->description }}" type="text" class="form-control @error('description') is-invalid @enderror" placeholder="@lang('admin.meta-description')">
                                                <div class="form-control-icon">
                                                    <i class="bi bi-pen"></i>
                                                </div>
                                                @error('description')
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input id="keywords" name="keywords" value="{{ $post->keywords }}" type="text" class="form-control @error('keywords') is-invalid @enderror" placeholder="@lang('admin.meta-keywords')">
                                                <div class="form-control-icon">
                                                    <i class="bi bi-pen"></i>
                                                </div>
                                                @error('keywords')
